...
$resourceGroupName = "leonms-landing-zone-rg"
$storageName = "leonmslandingzonesa"
$kvName = "leonms-landing-zone-kv"
$appName="leonms-landing-zone-app"
...
az storage container create `
    ...
    --name "leonms-landing-zone-tfstate" `
    --auth-mode login
